    ...
    public static void LinearRegression() {
        try {
            ...
            if (data != null) {
                ...
                System.out.println("Mean Absolute Error of M3: " + eval.meanAbsoluteError());
                System.out.println("Root Mean Square Error of M3: "+ eval.rootMeanSquaredError());
            } else {
